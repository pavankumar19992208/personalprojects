...
interface TwoPointersGuideProps {
  initialPage?: number;
  onPageChange?: (page: number) => void;
  onComplete?: () => void;
}

const TwoPointersGuide: React.FC<TwoPointersGuideProps> = ({
  initialPage = 0,
  onPageChange,
  onComplete,
}) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between pt-6 border-t border-slate-800">
        ...
        <button
          onClick={nextPage}
          disabled={page === 5 && completedPages[4] && initialPage < totalPages}
