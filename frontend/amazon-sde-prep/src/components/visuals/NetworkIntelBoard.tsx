    ...
    <div className="w-full p-6 bg-slate-950 font-sans text-slate-200">
      ...
      <div className="mb-10 border-l-4 border-orange-500 pl-6">
        <h1 className="text-3xl font-bold text-white tracking-tight">
          Network Protocol <span className="text-orange-500">Intel</span>
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {CN_TOPICS.map((topic, idx) => (
          <div
            key={idx}
            className="group relative bg-slate-900 border border-slate-800 rounded-xl p-6 hover:border-orange-500/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-orange-900/10"
          >
            ...
            <div className="pt-4 border-t border-slate-800/50">
              <p className="text-xs font-mono text-slate-500">
                <span className="text-orange-500 font-bold mr-1">WHY:</span>
                {topic.why}
              </p>
            </div>
          </div>
      ...
      <div className="mt-12 bg-gradient-to-r from-slate-900 to-slate-900/50 border border-slate-800 rounded-xl p-8 relative overflow-hidden">
        ...
        <div className="space-y-4 text-sm text-slate-300">
          <div className="flex items-center gap-4">
            <span className="font-mono text-orange-400">01</span>
            <p>
