...
const DBMS_TOPICS = [
  ...
  },
  {
    ...
    icon: <Server className="text-orange-500 dark:text-orange-400" />,
  },
  {
    ...
    icon: <Split className="text-purple-500 dark:text-purple-400" />,
  },
  {
    title: "CAP Theorem",
    difficulty: "High",
    ...
    icon: <Scale className="text-red-500 dark:text-red-400" />,
  },
  {
    ...
    icon: <RefreshCw className="text-cyan-500 dark:text-cyan-400" />,
  },
  {
    title: "Normalization",
    difficulty: "Medium",
    ...
    icon: <Table className="text-slate-500 dark:text-slate-400" />,
  },
];
    ...
    <div className="w-full p-6 bg-slate-50 dark:bg-slate-950 font-sans text-slate-900 dark:text-slate-200 pb-24 sm:pb-6">
      ...
      <div className="mb-10 border-l-4 border-blue-500 pl-6">
        <h1 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">
          Data Systems{" "}
          <span className="text-blue-600 dark:text-blue-500">Intel</span>
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {DBMS_TOPICS.map((topic, idx) => (
          <div
            key={idx}
            className="group relative bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 hover:border-blue-500/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-blue-900/10 dark:hover:shadow-blue-900/10 shadow-sm dark:shadow-none"
          >
            ...
            <div className="pt-4 border-t border-slate-100 dark:border-slate-800/50">
              <p className="text-xs font-mono text-slate-500">
                <span className="text-blue-600 dark:text-blue-500 font-bold mr-1">
                  WHY:
                </span>
                {topic.why}
              </p>
      ...
      <div className="mt-12 bg-gradient-to-r from-slate-100 to-white dark:from-slate-900 dark:to-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-xl p-8 relative overflow-hidden">
        <div className="absolute top-0 right-0 p-4 opacity-10">
          <Database size={120} className="text-slate-900 dark:text-white" />
        </div>
