    ...
    <div className="w-full p-6 bg-slate-950 font-sans text-slate-200">
      ...
      <div className="mb-10 border-l-4 border-purple-500 pl-6">
        <h1 className="text-3xl font-bold text-white tracking-tight">
          Operating System <span className="text-purple-500">Intel</span>
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {OS_TOPICS.map((topic, idx) => (
          <div
            key={idx}
            className="group relative bg-slate-900 border border-slate-800 rounded-xl p-6 hover:border-purple-500/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-purple-900/10"
          >
            ...
            <div className="pt-4 border-t border-slate-800/50">
              <p className="text-xs font-mono text-slate-500">
                <span className="text-purple-500 font-bold mr-1">WHY:</span>
                {topic.why}
              </p>
            </div>
          </div>
